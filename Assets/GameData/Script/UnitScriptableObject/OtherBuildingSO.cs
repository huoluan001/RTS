...
public class OtherBuildingSo : ScriptableObject, IBaseInfo, IBuilding, IWeapon, ISkill
{
    ...
    [Header("IBuilding")]
    [Tooltip("用途"), SerializeField] private BuildingLabelEnum label;
    ...
    public void SetBuilding(BuildingLabelEnum label, Vector2Int area, Vector2Int expandScope, Vector2 buildingAndPlacementTime, int powerConsume)
    {
        this.label = label;
        this.area = area;
